...
def build_gradient_magnitude_plot_parse_args():
    parser = argparse.ArgumentParser(description="Run the Train of the Recommender Model.")
    # Train
    parser.add_argument('--train', type=int, default=1)

    # Dataset
    parser.add_argument('--dataset', nargs='?', default='amazon', help='dataset name: movielens, pinterest, yelp, small_movielens, amazon')

    # Recommender Model
    parser.add_argument('--rec', nargs='?', default="amf", help="Use Only AMF (bprmf is executed for the first half epochs)")
